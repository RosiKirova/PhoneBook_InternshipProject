...
BOOL CPhonebookApp::InitInstance()
{
	...
	if (CDataSourceAccessor::OpenConnection() == FALSE)
	{
		AfxMessageBox(_T("An error occurred. A connection to the database cannot be achieved."));
	}
	...
	pDocTemplateCities = new CMultiDocTemplate(IDS_STRING_CITIES,
	...
	pDocTemplatePhoneTypes = new CMultiDocTemplate(IDS_STRING_PHONE_TYPES,
	...
	pDocTemplatePersons = new CMultiDocTemplate(IDS_STRING_PERSONS,
...
int CPhonebookApp::ExitInstance()
{
	...
	CDataSourceAccessor::CloseConnection();
